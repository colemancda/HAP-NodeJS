...
var lockUUID = uuid.generate('cerradura:accessories:lock');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake lock.
var lock = exports.accessory = new Accessory('Cerradura', lockUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
lock.username = "C1:5D:3A:EE:5E:FA";
lock.pincode = "561-99-315";

// set some basic properties (these values are arbitrary and setting them is optional)
lock
  .getService(Service.AccessoryInformation)
  .setCharacteristic(Characteristic.Manufacturer, "Smart Lock LATAM")
  .setCharacteristic(Characteristic.Model, "CerraduraOne")
  .setCharacteristic(Characteristic.SerialNumber, "AONE995551A");
...
lock
  .addService(Service.LockMechanism, "Cerradura") // services exposed to the user should have "names" like "Fake Light" for us
